namespace OJS.Data.Validation
{
    public static class ConstraintConstants
    {
        ...
        public static class User
        {
            ...
            public const string UsernameRegExpression = @"^[a-zA-Z]([/._]?[a-zA-Z0-9]+)+$";
            ...
            public const string EmailRegExpression = "^[A-Za-z0-9]+[\\._A-Za-z0-9-]+@([A-Za-z0-9]+[-\\.]?[A-Za-z0-9]+)+(\\.[A-Za-z0-9]+[-\\.]?[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$";
