...
var Contest = function Contest() {
  ...
  var renderTimeRemaining = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function () {
    if (!remainingTimeInMilliseconds) {
      return null;
    } // const a= addMilliseconds(new Date(),remainingTimeInMilliseconds);
    // const b=a.getTime();
    // const seconds = Math.floor(b / 1000);


    var a = new Date().setMilliseconds(new Date().getMilliseconds() + remainingTimeInMilliseconds);
    var secs = remainingTimeInMilliseconds / 1000;
...
//# sourceMappingURL=main.0a8d75c6d4745fd42ec0.hot-update.js.map