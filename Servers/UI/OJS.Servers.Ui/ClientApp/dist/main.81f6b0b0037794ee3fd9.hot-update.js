...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Undefined mixin.\n   ╷\n14 │   @include  theme-colors(max-width);\r\n   │   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  src\\components\\guidelines\\trees\\Tree.module.scss 14:3  root stylesheet");

/***/ })

})
//# sourceMappingURL=main.81f6b0b0037794ee3fd9.hot-update.js.map