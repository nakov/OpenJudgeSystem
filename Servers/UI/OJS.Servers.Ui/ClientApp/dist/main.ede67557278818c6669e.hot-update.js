...
var ContestCard = function ContestCard(_ref) {
  ...
  var checkLength = function checkLength(nameToCheck) {
    if (nameToCheck.length <= 20) {
      return nameToCheck;
    }

    return "".concat(nameToCheck.substring(0, 25), "...");
  };
...
//# sourceMappingURL=main.ede67557278818c6669e.hot-update.js.map