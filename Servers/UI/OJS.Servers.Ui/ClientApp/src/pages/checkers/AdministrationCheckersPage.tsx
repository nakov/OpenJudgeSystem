...
import { useDeleteCheckerMutation, useExportCheckersToExcelQuery, useGetAllCheckersQuery } from '../../redux/services/admin/checkersAdminService';
...
const AdministrationCheckersPage = () => {
    ...
    return (
        <AdministrationGridView
          ...
          excelMutation={useExportCheckersToExcelQuery}
        />
    );
};
