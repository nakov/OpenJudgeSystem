...
import { useDeleteContestMutation, useDownloadResultsMutation, useGetAllAdminContestsQuery, useGetContestsExcelFileQuery } from '../../../redux/services/admin/contestsAdminService';
    ...
    return (
        <>
            ...
            <AdministrationGridView
              ...
              excelMutation={useGetContestsExcelFileQuery}
            />
        </>
    );
};
