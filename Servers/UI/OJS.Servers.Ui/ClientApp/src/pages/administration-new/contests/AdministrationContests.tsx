...
import { useDeleteContestMutation, useDownloadResultsMutation, useGetAllAdminContestsQuery, useLazyGetContestsExcelFileQuery } from '../../../redux/services/admin/contestsAdminService';
    ...
    return (
        <>
            ...
            <AdministrationGridView
              ...
              excelMutation={useLazyGetContestsExcelFileQuery}
            />
        </>
    );
};
