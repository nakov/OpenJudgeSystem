...
import { useExportSubmissionTypesToExcelQuery, useGetAllSubmissionTypesQuery } from '../../../redux/services/admin/submissionTypesAdminService';
...
const AdministrationSubmissionTypesPage = () => {
    ...
    return (
        <AdministrationGridView
          ...
          excelMutation={useExportSubmissionTypesToExcelQuery}
        />
    );
};
