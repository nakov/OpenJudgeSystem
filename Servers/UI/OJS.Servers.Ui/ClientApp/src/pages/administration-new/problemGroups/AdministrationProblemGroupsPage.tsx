...
import { useExportProblemGroupsToExcelQuery, useGetAllAdminProblemGroupsQuery } from '../../../redux/services/admin/problemGroupsAdminService';
    ...
    return (
        <>
            ...
            <AdministrationGridView
              ...
              excelMutation={useExportProblemGroupsToExcelQuery}
            />
        </>
    );
};
