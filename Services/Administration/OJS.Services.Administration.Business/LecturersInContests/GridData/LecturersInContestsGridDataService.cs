...
{
    public LecturersInContestsGridDataService(IDataService<LecturerInContest> dataService, ISortingService sortingService, IFilteringService filteringService)
