...
public static class CacheConstants
{
    ...
    private const string IsCategoryChildOfInvisibleParent = "IsCategoryChildOfInvisibleParent:{0}";
    public static readonly CompositeFormat IsCategoryChildOfInvisibleParentFormat = CompositeFormat.Parse(IsCategoryChildOfInvisibleParent);
