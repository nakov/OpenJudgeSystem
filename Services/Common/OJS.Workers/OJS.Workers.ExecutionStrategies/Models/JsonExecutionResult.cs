        ...
        public static JsonExecutionResult Parse(string result, bool forceErrorExtracting = false, bool getTestIndexes = false)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < testsJs.Count; i++)
                {
                    ...
                    userTestsCount += currentTitle.ToString().StartsWith("Test 0 ", StringComparison.Ordinal) ? 1 : 0;
                    ...
                    initialPassedTests += (currentTitle.ToString().StartsWith("Test 1 ", StringComparison.Ordinal) && entry == null) ? 1 : 0;
                    errors.Add(entry);
