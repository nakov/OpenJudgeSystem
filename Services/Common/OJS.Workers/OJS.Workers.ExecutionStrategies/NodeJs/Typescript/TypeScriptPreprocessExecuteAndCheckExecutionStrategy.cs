...
public class TypeScriptPreprocessExecuteAndCheckExecutionStrategy<TSettings> : BaseInterpretedCodeExecutionStrategy<TSettings>
...
process.stdin.on('end', function() {
        ...
        IExecutionResult<TestResult> result)
    {
        ...
        if (!string.IsNullOrWhiteSpace(transpilationResult.ReceivedOutput))
        {
            ...
            result.CompilerComment = transpilationResult.ReceivedOutput;
            return result;
        }
        ...
        var jsCodeSavePath = this.SaveCodeToTempFile(executionContext);
    ...
    protected virtual string PreprocessJsSubmission<TInput>(string template, IExecutionContext<TInput> context)
    {
        ...
        var code = context.Code.Trim(TrimCharacter);
